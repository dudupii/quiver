...
Then call the Skill tool with "grilling" to converge the details within the chosen direction.
...
Do NOT implement anything. The user gates the next step. Suggest what they have available: `/to-spec` or `/grill-with-docs` (if the mattpocock skills are installed) to capture the design, or simply hand the agreed design to implementation.
